...
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
    ...
    class Shop {
        constructor() {
            ...
            const ribeyeSteak = new _item__WEBPACK_IMPORTED_MODULE_0__.Item("Ribeye Steak", 39.99, "One of the best cuts. Great marbling");
            const wine = new _item__WEBPACK_IMPORTED_MODULE_0__.Item("Wine Rioja", 10.99, "Sweet wine from Spain");
            const potatoes = new _item__WEBPACK_IMPORTED_MODULE_0__.Item("Golden Potato", 6.99, "Bag golden potatoes");
    ...
    (() => {
    __webpack_require__.r(__webpack_exports__);
    /* harmony import */ var _user__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
    ...
    function updateUI() {
        ...
        if (availableItemsList && userCartList && totalAmountDisplay) {
            ...
            user.getCart().forEach((item) => {
                ...
                removeOneBtn.className = "btn btn-danger cartButton";
                removeOneBtn.addEventListener("click", () => {
                    // Decrease the quantity by 1
                    user.updateCartQuantity(item, -1);
                    updateUI();
                });
